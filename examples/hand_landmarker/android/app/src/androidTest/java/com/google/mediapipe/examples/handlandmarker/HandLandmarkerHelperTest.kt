...
class HandLandmarkerHelperTest {
    ...
    /**
     * Verify that the result returned from the Hand Landmarker Helper with VIDEO mode is within the
     * acceptable range to the expected result.
     */
    @Test
    ...
    /**
     * Verify that the result returned from the Hand Landmarker Helper with IMAGE mode is within the
     * acceptable range to the expected result.
     */
    @Test
